<div class="links index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('link_text');?></th>
			<th><?php echo $this->Paginator->sort('link_uri');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $link['Link']['link_text']; ?>&nbsp;</td>
		<td><?php echo $link['Link']['link_uri']; ?>&nbsp;</td>
		<td class="actions">
